...
import { LocationService } from '@hop-hv-rag/core';
...
async function main() {
  ...
  console.log('Populating Locations and Variants...');
  ...
  console.log(`Populated ${canonicals.size} canonical locations/settings.`);
