...
import { ActivityService, logger } from '@hop-hv-rag/core';
...
async function main() {
  ...
  logger.info('Populating Activities and Variants...');
  ...
  logger.info({ count: canonicals.size }, 'Populated canonical activities');

  // 2. Link Videos
  logger.info('Linking Videos...');
